...
namespace System.Text.Json
{
    public sealed partial class Utf8JsonWriter
    {
        ...
        private void WriteStringIndented(ReadOnlySpan<char> escapedPropertyName, DateTime value)
        {
            ...
            int maxRequired = indent + (escapedPropertyName.Length * JsonConstants.MaxExpansionFactorWhileTranscoding) + JsonConstants.MaximumFormatDateTimeOffsetLength + 7 + 2;
